...
--    with a gin_trgm_ops index. pg_trgm is installed by 0139 (CREATE EXTENSION
--    cannot run here: later migrations create pg_temp objects, and hosted
--    Postgres rejects CREATE EXTENSION while the session temp schema is dirty).
